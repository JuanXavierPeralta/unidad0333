...
public String toString() {
        return "Carrera{" + "nombre=" + nombre + ", direcorCarrera=" + direcorCarrera 
                + ", costoCiclo=" + costoCiclo + ", numCiclos=" + numCiclos 
                + ", yearInaguracion=" + yearInaguracion+", Costo total="
                +this.costoTotalCarrera() +", año de la carrera="+this.yearCarrera() 
