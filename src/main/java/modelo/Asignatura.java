...
public class Asignatura {
    ...
    private int costoHoras;
    private int cuposDisponibles;
    private Carrera Carrera;
    private String modalidad;

    public Asignatura(String nombre, String docente, int numHoras, int horasSemanales, int costoHoras, int cuposDisponibles, Carrera Carrera, String modalidad) {
        this.nombre = nombre;
    ...
    public void setCostoHoras(int costoHoras) {
        this.costoHoras = costoHoras;
    }
